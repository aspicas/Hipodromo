...
alter table ejemplar add constraint CH_ejem_sexo check (ejem_sexo IN ('C','Y'));
alter table ejemplar add constraint CH_ejem_pelaje check (ejem_pelaje IN ('C','A','Z','T'));
