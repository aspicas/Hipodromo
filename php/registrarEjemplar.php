...
elseif (isset($_POST['modificar'])) {
	...
	try {
		...
		Query("update ejemplar set ejem_nombre='".$nombre."',ejem_pelaje='".$pelaje."',ejem_fecha_nac=to_date('".$fnac."','yyyy-mm-dd'),ejem_sexo='".$sexo."',ejem_tatuaje='".$tatuaje."',ejem_raza='".$raza."',fk_ejem_m='".$madre."',fk_ejem_p='".$padre."',fk_hara=(select hara_codigo from haras where hara_nombre='".$haras."' and fk_luga = (select LUGA_codigo from lugar where luga_nombre='".$parroquia."' and luga_tipo='parroquia' and fk_luga = (select LUGA_codigo from lugar where luga_nombre='".$municipio."' and luga_tipo='municipio' and fk_luga = (select LUGA_codigo from lugar where luga_nombre='".$estado."' and luga_tipo='estado' and fk_luga = (select LUGA_codigo from lugar where luga_nombre='".$pais."' and luga_tipo='pais'))))),fk_pues=(select pues_codigo from puesto, caballeriza where pues_numero = '".$puesto."' and caba_numero = '".$caballeriza."' and fk_caba = caba_codigo) where ejem_codigo=".$codigo."");
